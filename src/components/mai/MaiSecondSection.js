                    ...
                    <div className="container">
                        <div className={classNames("features-tiles-inner mai-features")}>
                            ...
                            <div className="row pt-4">
                                <div class="col-sm-3">
                                    <div class="icon"><img src={require('../../assets/Images/mai/icon1.png')} alt=""/></div>
                                ...
                                <div class="col-sm-3">
                                    <div class="icon"><img src={require('../../assets/Images/mai/icon2.png')} alt=""/></div>
                                    <div className="mai2-content">
                                ...
                                <div class="col-sm-3">
                                    <div class="icon"><img src={require('../../assets/Images/mai/icon3.png')} alt=""/></div>
                                    <div className="mai2-content">
                                ...
                                <div class="col-sm-3">
                                    <div class="icon"><img src={require('../../assets/Images/mai/icon4.png')} alt=""/></div>
                                    <div className="mai2-content">
